...
PROJECT = {
  ...
  "title": "Atlas Visual Do Desmatamento Na Amazonia",
  "discipline": "Estrutura E Visualizacao De Dados I",
  "disciplinePt": "Estrutura E Visualizacao De Dados I",
  "kind": "deforestation",
  "dataset": "Amostra segura local",
  "source": "Amostra sintetica local",
  "description": "Series temporais, comparacoes e heatmaps com amostras inspiradas no PRODES/INPE.",
  "topics": [
    "data-science",
    "python",
    "jupyter-notebook",
