...
PROJECT = {
  "code": "P11",
  "slug": "amazon-deforestation-atlas",
  "title": "Amazon Deforestation Atlas",
  "discipline": "Data Structure and Visualization I",
  "disciplinePt": "Estrutura e Visualizacao de Dados I",
  "difficulty": "Intermediate",
  "difficultyPt": "Intermediario",
  "kind": "deforestation",
  "dataset": "PRODES/INPE-style deforestation sample",
  "source": "https://terrabrasilis.dpi.inpe.br/",
  "description": "Visualization lab for Amazon deforestation time series, comparisons, and correlation heatmaps.",
  "concepts": [
    "line charts",
    "bar charts",
    "heatmaps",
